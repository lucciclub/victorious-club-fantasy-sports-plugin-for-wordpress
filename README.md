# victorious-club-fantasy-sports-plugin-for-wordpress
...
Create a fantasy sports website in minutes. Give your members the chance to compete in daily contests by predicting the outcomes of sporting events.
...
Annual subscription of $499 per year, easy to install,  we have our own wordpress theme that is guarantied to work,  native mobile apps available for IOS and android.  Automated data feeds supported for all major sports around the world.  So users don't have to manually enter any data, all the player rosters, schedules, and updates are all automated.  Multiple payment gateways are supported. We have stock market and crypto market games.  Use it for any niche. Not just sports, but TV shows, movies, politics and more. 
We have great customer service. The plugin is open source.  

Data feeds pricing:  $750 per month per sport for real time stats.  $550 per month per sport for delayed stats of 15 minutes.  $350 per month per sport for delayed stats of 3 hours or $150 per month per sport for stats that are updated once per day.
...
The game type defines what game to play. This is where you can offer Victorious Club's standard game types or have us build you a custom game type.
...
This page is updated according to Victorious Club stats engine technology.  Victorious Club strives try to make it as real-time as possible. However,  you can integrate other statistical vendors to our plugin.  Please contact us for details.
...
1. Upload `victorious.php` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Sign up at http://Victorious.Club and go to Members Area
4. Copy and paste license key from Members Area to your Admin CP

Using The WordPress Dashboard

1. Navigate to the 'Add New' in the plugins dashboard
2. Search for ‘Victorious Club Fantasy Sports’
3. Click 'Install Now'
...
3. Select victorious.zip from your computer
4. Click 'Install Now'

Activate the plugin in the Plugin dashboard

1. Using FTP
2. Download victorious.zip
3. Extract the victorious directory to your computer
4. Upload the victorious directory to the /wp-content/plugins/ directory
5. Activate the plugin in the Plugin dashboard
6. Sign up at http://Victorious.Club and go to Members Area
...
Yes. We have 24 hour email support for both levels of licences.  Please email support@victorious.club for any issues, questions or concerns. Your feedback is most welcome.  
